...
<div class="sidebar pe-4 pb-3">
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{URL::to('/dashboard')}}" class="nav-item nav-link "><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    ...
                    <a href="{{URL::to('/foody/forbidden')}}" class="nav-item nav-link"><i class="fas fa-utensils me-2"></i>Forbidden</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{URL::to('/foody/diseases')}}" class="dropdown-item">Diseases</a>
                            <a href="{{URL::to('/foody/forbidden')}}" class="dropdown-item">Forbidden Foods</a>
                            <a href="{{URL::to('/foody/alternatives')}}" class="dropdown-item">Alternatives</a>
                        </div>
                    </div>
