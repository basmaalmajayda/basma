...
<div class="sidebar pe-4 pb-3">
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{URL::to('/foody/coupons')}}" class="nav-item nav-link"><i class="fa fa-sign-language me-2"></i>Coupons</a>
                    ...
                    <a href="{{URL::to('/foody/notifications')}}" class="nav-item nav-link"><i class="fa fa-envelope me-2"></i>Notifications</a>
