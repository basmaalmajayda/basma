...
// Route::post('/foody/storeCategory', 'Admin\AdminCategoryController@store');
Route::get('/foody/editCategory', 'Admin\AdminCategoryController@edit');
// Route::post('/foody/updateCategory', 'Admin\AdminCategoryController@update');
// Route::get('/foody/deleteCategory', 'Admin\AdminCategoryController@destroy');
// Route::get('/foody/restoreCategory', 'Admin\AdminCategoryController@restore');

Route::get('/foody/foods', 'Admin\AdminFoodController@index');
Route::get('/foody/addFood', 'Admin\AdminFoodController@create');
Route::post('/foody/storeFood', 'Admin\AdminFoodController@store');
Route::get('/foody/editFood/{id}', 'Admin\AdminFoodController@edit');
Route::post('/foody/updateFood', 'Admin\AdminFoodController@update');
Route::get('/foody/deleteFood/{id}', 'Admin\AdminFoodController@destroy');
Route::get('/foody/restoreFood/{id}', 'Admin\AdminFoodController@restore');
